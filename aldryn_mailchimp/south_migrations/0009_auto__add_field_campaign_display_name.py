...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.display_name'
        db.add_column(u'aldryn_mailchimp_campaign', 'display_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.display_name'
        db.delete_column(u'aldryn_mailchimp_campaign', 'display_name')
    ...
    models = {
        ...
        u'aldryn_mailchimp.keyword': {
            'Meta': {'ordering': "('order', 'value')", 'object_name': 'Keyword'},
