...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubscriptionPlugin'
        db.create_table('cmsplugin_subscriptionplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('list_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('aldryn_mailchimp', ['SubscriptionPlugin'])


    def backwards(self, orm):
        # Deleting model 'SubscriptionPlugin'
        db.delete_table('cmsplugin_subscriptionplugin')
